...
public class C2V_Ex01 {
	...
	public ModelAndView ModelAndViewEx() {// return타입은 string이 아닌 ModelAndView 클래스를 작성한다.
	
		//ModelAndView mv = new ModelAndView();   //ModelAndView 객체를 생성한다.
		//mv.setViewName("chapter01_form/view"); 	// view경로를 작성한다.
	
		ModelAndView mv = new ModelAndView("chapter01_form/view");   //ModelAndView 객체를 생성한다.
